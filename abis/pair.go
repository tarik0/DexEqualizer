...
// PairMetaData contains all meta data concerning the UniswapPair contract.
...
// NewPair creates a new instance of UniswapPair, bound to a specific deployed contract.
func NewPair(address common.Address, backend bind.ContractBackend) (*UniswapPair, error) {
	contract, err := bindPair(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &UniswapPair{PairCaller: PairCaller{contract: contract}, PairTransactor: PairTransactor{contract: contract}, PairFilterer: PairFilterer{contract: contract}}, nil
}

// NewPairCaller creates a new read-only instance of UniswapPair, bound to a specific deployed contract.
...
// NewPairTransactor creates a new write-only instance of UniswapPair, bound to a specific deployed contract.
...
// NewPairFilterer creates a new log filterer instance of UniswapPair, bound to a specific deployed contract.
...
// PairApprovalIterator is returned from FilterApproval and is used to iterate over the raw logs and unpacked data for Approval events raised by the UniswapPair contract.
...
// PairApproval represents a Approval event raised by the UniswapPair contract.
...
// PairBurnIterator is returned from FilterBurn and is used to iterate over the raw logs and unpacked data for Burn events raised by the UniswapPair contract.
...
// PairBurn represents a Burn event raised by the UniswapPair contract.
...
// PairMintIterator is returned from FilterMint and is used to iterate over the raw logs and unpacked data for Mint events raised by the UniswapPair contract.
...
// PairMint represents a Mint event raised by the UniswapPair contract.
...
// PairSwapIterator is returned from FilterSwap and is used to iterate over the raw logs and unpacked data for Swap events raised by the UniswapPair contract.
...
// PairSwap represents a Swap event raised by the UniswapPair contract.
...
// PairSyncIterator is returned from FilterSync and is used to iterate over the raw logs and unpacked data for Sync events raised by the UniswapPair contract.
...
// PairSync represents a Sync event raised by the UniswapPair contract.
...
// PairTransferIterator is returned from FilterTransfer and is used to iterate over the raw logs and unpacked data for Transfer events raised by the UniswapPair contract.
...
// PairTransfer represents a Transfer event raised by the UniswapPair contract.
